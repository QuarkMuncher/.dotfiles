...
--
myWorkspaces    = ["1:term","2:browser","3:client", "4:server", "5:Whatever"]
...
myStartupHook = do
  ...
  spawnOnce "picom &"
  spawnOnce "xmodmap /home/Master/.Xmodmap &"
...
--
main = do
  xmobarProc <- spawnPipe "xmobar -x 0 /home/Master/.config/xmobar/xmobar.config"
  xmonad $ docks $ def {
      -- simple stuff
        terminal           = myTerminal,
